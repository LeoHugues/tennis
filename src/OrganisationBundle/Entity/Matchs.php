...
class Matchs
{
     ...
     * @var Terrain
     *
     * @ORM\ManyToOne(targetEntity="OrganisationBundle\Entity\Terrain", inversedBy="matchs", cascade={"persist", "remove"})
     */
    private $terrain;
     ...
     * @ORM\OneToOne(targetEntity="OrganisationBundle\Entity\Equipe")
     ...
     * @var Point
     *
     * @ORM\OneToMany(targetEntity="OrganisationBundle\Entity\Point", mappedBy="match", cascade={"persist", "remove"})
     */
    private $points;
